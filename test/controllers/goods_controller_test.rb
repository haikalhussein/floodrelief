...
class GoodsControllerTest < ActionController::TestCase
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post :create, good: { item: @good.item, quantity: @good.quantity, received_date: @good.received_date, received_from: @good.received_from }
    end
  ...
  test "should update good" do
    patch :update, id: @good, good: { item: @good.item, quantity: @good.quantity, received_date: @good.received_date, received_from: @good.received_from }
    assert_redirected_to good_path(assigns(:good))
  end
